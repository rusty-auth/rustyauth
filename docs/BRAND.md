...
`application/vnd.passkey-auth.backup.v1` remain stable until a versioned migration requires a
change. Branding is not a reason to break stored data or clients.
