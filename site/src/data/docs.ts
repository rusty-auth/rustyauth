  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Security model, hardened defaults and continuous assurance.",
    ...
    items: [
      {
        ...
        description: "What 1.0.0 supports, what remains preview and what comes next.",
        keywords: ["status", "roadmap", "limitations", "release", "1.0.0", "ga"],
      },
    ],
  },
];
