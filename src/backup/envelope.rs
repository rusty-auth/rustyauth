//! AES-256-GCM backup envelope sealing and unsealing: compress-then-encrypt with
//! the versioned header (magic, key id, nonce) authenticated as AAD, failing closed.
