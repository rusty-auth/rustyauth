{{- define "rustyauth-integrated.name" -}}
{{- default .Chart.Name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "rustyauth-integrated.fullname" -}}
...
{{- define "rustyauth-integrated.labels" -}}
helm.sh/chart: {{ printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | quote }}
app.kubernetes.io/name: {{ include "rustyauth-integrated.name" . }}
...
{{- define "rustyauth-integrated.image" -}}
{{- if .digest -}}
...
{{- define "rustyauth-integrated.secretName" -}}
{{- default (printf "%s-secrets" (include "rustyauth-integrated.fullname" .)) .Values.secrets.existingSecret -}}
{{- end -}}

{{- define "rustyauth-integrated.configMapName" -}}
{{- default (printf "%s-config" (include "rustyauth-integrated.fullname" .)) .Values.config.existingConfigMap -}}
{{- end -}}

{{- define "rustyauth-integrated.config" -}}
...
spec:
  ...
  datastore:
    endpoint: {{ printf "redis://%s-sabledb.%s.svc.%s:6379" (include "rustyauth-integrated.fullname" .) .Release.Namespace .Values.clusterDomain | quote }}
  relyingParty:
